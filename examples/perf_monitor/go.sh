...
exec sudo $SCRIPTPATH/build/perf_monitor -l $cpu -n 3 --proc-type=secondary --file-prefix onvm -- -r $service $clientname $instance -- -d $dst $print
